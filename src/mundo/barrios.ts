...
export interface FichaBarrio {
  ...
  poblacion: { vecinos: number; trafico: number; buses: number; motos: number; coches: number; sevici: number };
...
export const BARRIOS: Record<string, FichaBarrio> = {
  'pino-montano': {
    ...
    poblacion: { vecinos: 110, trafico: 14, buses: 1, motos: 14, coches: 12, sevici: 8 },
    tribu: 'canis',
  ...
  alameda: {
    ...
    poblacion: { vecinos: 160, trafico: 10, buses: 1, motos: 18, coches: 10, sevici: 0 },
    tribu: 'modernos',
  ...
  triana: {
    ...
    poblacion: { vecinos: 150, trafico: 12, buses: 1, motos: 16, coches: 12, sevici: 8 },
    tribu: 'trianeros',
